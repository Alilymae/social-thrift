...
export const Footer = ({ onNavigate }: FooterProps) => {
  ...
  return (
    <footer
      className="bg-white border-t border-primary py-20 mt-auto dark:bg-dark/30 dark:border-pink"
      style={{
        width: "100vw",
        position: "relative",
        left: "50%",
      ...
      <div className="max-w-6xl mx-auto px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-5 gap-16 md:gap-12">
          <div className="space-y-8 col-span-1 md:col-span-2 lg:col-span-2">
            <div className="space-y-4">
              ...
              <p className="text-dark/50 max-w-sm leading-relaxed text-lg dark:text-cream-support">
                Where fashion meets purpose, community, and a more sustainable future.
              </p>
            </div>
            <div className="flex gap-4">
              {[
                { icon: Instagram, href: "https://www.instagram.com/_socialthrift_/" },
                { icon: Instagram, href: "https://www.instagram.com/re.thriva/" },
                { icon: Mail, href: "mailto:rethriva.co@gmail.com" },
                { icon: Mail, href: "mailto:rethriva.support@gmail.com" }
              ].map((social, i) => (
                <a 
                  key={i}
                  href={social.href} 
                  className="w-12 h-12 bg-light-green/60 dark:bg-cream rounded-2xl flex items-center justify-center text-primary dark:text-dark-green hover:text-dark dark:hover:text-dark-green hover:bg-[#FFD7E1] dark:hover:bg-light-green transition-all duration-300 border border-primary/20 hover:border-pink dark:hover:border-dark-green dark:border-dark-green"
                >
                  <social.icon size={20} />
                </a>
              ))}
          ...
          <div className="space-y-6">
            <h4 className="font-bold text-primary uppercase tracking-widest text-s dark:text-primary">Platform</h4>
              ...
              {[
                ...
                <li key={i}>
                  <button 
                    ...
                    className="text-dark/50 dark:text-cream-support hover:text-pink dark:hover:text-lavender-support transition-colors font-medium flex items-center gap-2 group text-left"
                  >
                    {link.label}
          ...
          <div className="space-y-6">
            <h4 className="font-bold text-primary uppercase tracking-widest text-s">Support</h4>
            <ul className="space-y-4">
              {[
                ...
                <li key={i}>
                  <button 
                    onClick={() => onNavigate(link.tab)}
                    className="text-dark/50 dark:text-cream-support hover:text-orange dark:hover:text-light-green transition-colors font-medium flex items-center gap-2 group text-left"
                  >
                    {link.label}
                    <ArrowUpRight size={14} className="opacity-0 -translate-y-1 translate-x-1 group-hover:opacity-100 group-hover:translate-y-0 group-hover:translate-x-0 transition-all" />
                  </button>
          ...
          <div className="space-y-6 lg:col-span-1">
            <h4 className="font-bold text-primary uppercase tracking-widest text-s">Newsletter</h4>
            <p className="text-dark/50 dark:text-cream text-s">Stay updated with the latest trends and upcycling tips.</p>
            <form onSubmit={handleSubscribe} className="space-y-3">
              <div className="relative">
                <input 
                  ...
                  className="w-full bg-[#DDFFE2] dark:bg-cream border border-zinc-100 rounded-2xl px-4 py-4 text-sm text-dark-green focus:outline-none focus:ring-2 focus:ring-primary/20 transition-all"
                />
                <button 
                  type="submit"
              ...
              <button 
                ...
                className="text-[10px] text-dark/30 dark:text-primary hover:text-primary dark:hover:text-pink transition-colors uppercase tracking-widest font-bold"
              >
        ...
        <div className="mt-20 pt-10 border-t border-black/5 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex items-center gap-2 text-sm text-primary font-medium">
            Made with <Heart size={16} className="text-pink fill-pink animate-pulse" /> for a more sustainable future.
          </div>
        </div>
      </div>
    </footer>
